const CATEGORY_KEYWORDS = {
  ...
  'software-subscriptions': ['saas', 'software', 'subscription', 'github', 'aws', 'azure', 'google cloud', 'digitalocean', 'heroku'],
...
const PERSONAL_KEYWORDS = ['grocery', 'supermarket', 'walmart', 'costco', 'pharmacy', 'clothing', 'entertainment', 'streaming', 'netflix', 'spotify', 'gym', 'fitness'];
